    ...
    <section className="relative">
      ...
      <div className="md:hidden">
        ...
        <img
          ...
          alt="LifeCare EMS of Georgia — Emergency & Non-Emergency Medical Transport Across Georgia"
      ...
      <h1 className="sr-only">
        Emergency &amp; Non-Emergency Medical Transport Across Georgia — LifeCare EMS of Georgia
      </h1>
    </section>
  );
}
